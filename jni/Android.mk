...
include $(CLEAR_VARS)
LOCAL_MODULE := moto-g-gen5-test
LOCAL_SRC_FILES := $(LOCAL_PATH)/test/mock/moto-g-gen5.cc
LOCAL_C_INCLUDES := $(LOCAL_PATH)/test/mock
LOCAL_STATIC_LIBRARIES := cpuinfo_mock gtest
include $(BUILD_EXECUTABLE)
...
include $(CLEAR_VARS)
LOCAL_MODULE := galaxy-s9-global-test
LOCAL_SRC_FILES := $(LOCAL_PATH)/test/mock/galaxy-s9-global.cc
LOCAL_C_INCLUDES := $(LOCAL_PATH)/test/mock
LOCAL_STATIC_LIBRARIES := cpuinfo_mock gtest
include $(BUILD_EXECUTABLE)
...
include $(CLEAR_VARS)
LOCAL_MODULE := huawei-p20-pro-test
LOCAL_SRC_FILES := $(LOCAL_PATH)/test/mock/huawei-p20-pro.cc
LOCAL_C_INCLUDES := $(LOCAL_PATH)/test/mock
LOCAL_STATIC_LIBRARIES := cpuinfo_mock gtest
include $(BUILD_EXECUTABLE)
...
include $(CLEAR_VARS)
LOCAL_MODULE := oppo-r15-test
LOCAL_SRC_FILES := $(LOCAL_PATH)/test/mock/oppo-r15.cc
LOCAL_C_INCLUDES := $(LOCAL_PATH)/test/mock
LOCAL_STATIC_LIBRARIES := cpuinfo_mock gtest
include $(BUILD_EXECUTABLE)
